  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center z-50">
      ...
      <div className="relative bg-white w-11/12 max-w-lg rounded-md shadow-lg z-50 max-h-[90vh] overflow-y-auto p-6 space-y-6">
        ...
        {event.eventDescription && (
          <p className="text-gray-600 text-center">{event.eventDescription}</p>
        )}
        {mapUrl && (
          <div className="mt-4">
            <iframe
...
function UserOptionsPopup({ onClose }) {
  ...
  return (
    <div className="absolute top-full right-0 mt-2 w-32 bg-white border border-gray-300 rounded shadow-md p-2">
      <button
...
export default function Events() {
  ...
  useEffect(() => {
    ...
    if (nameFromStorage && nameFromStorage !== "User") {
    ...
    <div className="min-h-screen bg-white">
      <nav className="flex items-center justify-between px-6 py-4 bg-white shadow-md rounded-lg">
        ...
        {displayName === "User" ? (
          ...
          <div className="relative" onClick={() => setShowUserOptions(!showUserOptions)}>
            <div className="px-4 py-2 rounded-full bg-gray-200 text-black font-semibold cursor-pointer">
              Hello, {displayName}
            </div>
            {showUserOptions && <UserOptionsPopup onClose={() => setShowUserOptions(false)} />}
          </div>
        )}
      </nav>
